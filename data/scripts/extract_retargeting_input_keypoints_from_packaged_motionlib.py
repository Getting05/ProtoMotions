...
Supports SMPL, SMPL-X, and SOMA skeleton formats.
...
def main(
    ...
    skeleton_format: str = typer.Option(
        "smpl",
        "--skeleton-format",
        help="Skeleton format: 'smpl', 'smplx', or 'soma'.",
    ),
    ...
    if skeleton_format not in ["smpl", "smplx", "soma"]:
        print(
            "Error: skeleton_format must be 'smpl', 'smplx', or 'soma'. "
